...
/** All the full generated event catalogue names resolve and register. */
class GeneratedEventsCatalogueTest {
    ...
    @Test void resolve() throws IOException {
        ...
        assertTrue(j, "all generated event names must resolve");
    }
}
