...
> **Status:** Phase 0 (Foundations). The build, plugin bootstrap, Folia-aware scheduler, and the
> draft public API are in place. See [`docs/PLAN.md`](docs/PLAN.md) for the full plan and roadmap.
